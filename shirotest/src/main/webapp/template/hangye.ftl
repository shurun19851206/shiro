...
<!--增加部分-->
 <div class="container">
        ...
        <a href="canye_1.html" style=" color: white;">
		   <div class="aboutborder" style="margin-top:60px;">
    			<div class="aboutwriting1">产业报告
				</div>
		   </div>
		   </a>
		   <a href="#" style=" color: #FF5454;">
		   	<div class="containerabout" style="margin-top:30px;">
				<div class="aboutwriting">行业动态
				</div>
			</div>
			</a>
...
<div class="col-md-8 blog_left" style="width:85%; box-shadow: 0 2px 6px #ccc;margin-top:50px; margin-left:60px;">
				<h3><span style="margin-left:10px;">行业动态</span></h3>
			<div class="technology_list">
				<#list infolist as hangye>
					<h4 style="font-style:normal; color:#3B3B3B;">${hangye.info_title }</h4>
					<div class="col-md-10 tech_para" id="content_${hangye_index}" displayLength="232" style="font-size:14px;">
						<p class="para" style="font-style:normal; color:#3B3B3B;">${hangye.info_content}
						</p>
					</div>
					<div class="col-md-2 images_1_of_4 bg1 pull-right" style="margin-top:-15px;margin-right: -30px;">
						<span class="bg" style="width: 78px;height: 78px;line-height: 78px; font-size:14px;; text-align:center; color:#E0E0E0; font-family:微软雅黑;">${hangye.info_pubdate}</span>
					</div>
					<div class="clearfix"></div>
					<div class="read_more">
						<a href="../${hangye.info_id}.html" target="_blank" class="fa-btn btn-1 btn-1e" style="padding:0;margin-top: 2px;margin-bottom: 22px;width: 80px;height: 30px;text-align: center;line-height: 22px;">资讯详情</a>
					</div>	
				</#list>
			</div>
